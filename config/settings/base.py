...
LOCAL_APPS = ["core_apps.user_auth", "core_apps.common", "core_apps.user_profile", "core_apps.accounts", "core_apps.cards"]
...
#It has 3 possible values: Strict, Lax, None
#Lax - Send the cookies only when the request looks normal and safe
