...
"""
This model stores views on content.

Example:
Someone viewed a blog
or a product
or a video
or any other model in your system
...
class ContentView(TimeStampedModel):
    ...
    #related_name - From the User model, we can access all view records using user.content_views.
