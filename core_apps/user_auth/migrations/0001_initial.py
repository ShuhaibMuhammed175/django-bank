# Generated by Django 4.2.15 on 2025-12-21 07:28
            ...
            fields=[
                ...
                (
                    ...
                    models.CharField(
                        choices=[
                            ...
                            ("favorite_color", "What is your mother's favorite color?"),
                            (
                                "birth_city",
                                "What is the name of the city where you born?",
                            ),
                            (
                                "child_friends",
                                "What is the name of your childhood friends?",
                            ),
                        ],
                        max_length=30,
                ...
                (
                    ...
                    models.CharField(
                        choices=[
                            ("customer", "Customer"),
                            ("account_execute", "Account Executive"),
                            ("teller", "Teller"),
