...
#InvalidOperation → an exception that is raised
#when something goes wrong while converting/working with Decimal
from django.db import transaction
from loguru import logger
from rest_framework import generics, status
from rest_framework.exceptions import PermissionDenied
#PermissionDenied is an exception you raise when
#the user is not allowed to perform a certain action in an API.
...
class VirtualCardTopUpAPIView(generics.UpdateAPIView):
    ...
    def update(self, request, *args, **kwargs):
        ...
        print(model_to_dict(virtual_card))
